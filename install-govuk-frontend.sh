...
sed -i "s/\/assets\//assets\//" node_modules/govuk-frontend/settings/_assets.scss

# Create an scss file to import all of govuk-frontend -- only has to be done once
# echo "@import \"node_modules/govuk-frontend/all\";" > govuk.scss
...
sed -i "s/sans-serif-tabular/sans-serif/" node_modules/govuk-frontend/settings/_typography-font.scss
...
mv node_modules/govuk-frontend/assets inst/rmarkdown/resources/
mv node_modules/govuk-frontend/all.js inst/rmarkdown/resources
# rm -r node_modules
