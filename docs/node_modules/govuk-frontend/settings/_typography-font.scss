...
$govuk-font-family-tabular: sans-serif-tabular !default;
...
///
/// If you have set $govuk-font-family to something other than sans-serif this option is disabled by default.
///
...
$govuk-include-default-font-face: (
  $govuk-font-family == sans-serif and
