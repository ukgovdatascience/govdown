...
the GOV.UK Design System.  This website is an example.
:::
...
The package is only hosted on GitHub, not on CRAN.  Install it with the devtools
package.
...
Thiz pozt sayz what'z tazty about nectar.
```
...
navbar:
  ...
  service_name: "GOV.UK-style markdown documents"
  links:
    - text: "Home"
      href: index.html
    - text: "Tech docs"
...
**Bold** and *italics* work as ***normal***.
...
The syntax uses the summary attribute is to provide the top level information 
with the content provided by the text within.
